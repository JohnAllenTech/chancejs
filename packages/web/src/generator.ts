import { Generator, GeneratorOptions, n, times } from '@johnallentech/generator'
...
import { BlueImpMD5 } from '@johnallentech/blue-imp-md5'
import { HexGenerator } from '@johnallentech/hex'
