...
describe('pickSet method', () => {
  ...
  it('returns empty array when count 0', () => {
    const arr = ['a', 'b', 'c', 'd']
    times(1000, () => {
      const picked = chance.pickSet(arr, 0)
  ...
  it('throws if zero elements in array', () => {
    expect(() => chance.pickSet([], 1)).toThrow(
  ...
  it('throws if count is not positive number', () => {
    const arr = ['a', 'b', 'c', 'd']
    expect(() => chance.pickSet(arr, -1)).toThrow(
  ...
  it('returns single element array when called with count of 1', () => {
    const arr = ['a', 'b', 'c', 'd']
    times(1000, () => {
      const picked = chance.pickSet(arr, 1)
  ...
  it('returns multiple elements when called with count > 1', () => {
    const arr = ['a', 'b', 'c', 'd']
    times(1000, () => {
      const picked = chance.pickSet(arr, 3)
  ...
  it('returns no more values than the size of the array', () => {
    const arr = ['a', 'b', 'c', 'd']
    times(1000, () => {
      const picked = chance.pickSet(arr, 5)
  ...
  it('returns unique values', () => {
    const arr = ['a', 'b', 'c', 'd']
    times(1000, () => {
      const picked = chance.pickSet(arr, 4)
